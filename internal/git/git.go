...
func (r *Repo) env() []string {
	...
	// The environment is inherited whole, GIT_DIR included: ADR-0001 binds
	// autogit to behave as the user's own git does, and `git commit` under
	// GIT_DIR=~/.dotfiles commits to that repository. Isolating from it is a
	// test concern — see Environ.
